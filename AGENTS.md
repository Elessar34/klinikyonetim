- Bir web sitesi kodlarken tarayıcı açıp, kontrol etmeye çalışma. Bana söyle, ben bakarım veya sana SS atarım.
- Her yapılan web sitesi SEO açısından kusursuz olmalı. Mevcut bilinen tüm SEO kurallarına uymalı 
- Hem SEO hemde GEO Analizi yapılmalı.
- Security kısmıyla alakalı olarak web sitelerinde açık verilmemeli. rate limitler kontrol edilmeli ve sağlanmalı, api key gibi oldukça önemli unsurlar hardcoded veya açık bir şekilde yazılmamalı.
- Attack veya hack denemeleri yapılmalı ve kontrolü sağlanmalı.
- Yeni fikirlere her zaman açığım, aklıma geldikçe bana fikir sunabilirsin.
- Güvenlik her şeydir. Bunu unutma.
